...
<div class="container2">
  ...
  <h3>REPORTE PERIODO RESULTADO </h3>
...
$fecha1 =$_POST['Anual1'].$_POST['Mes1'].$_POST['Dia1'];
$fecha2 =$_POST['Anual2'].$_POST['Mes2'].$_POST['Dia2'];
...
<div>
<center><h3>Informe correspondiente al periodo:<?php echo ($_POST['Anual1']."-".$_POST['Mes1']."-".$_POST['Dia1']." a ".$_POST['Anual2']."-".$_POST['Mes2']."-".$_POST['Dia2']);?></p>   
</div>
