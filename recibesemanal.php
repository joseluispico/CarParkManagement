...
<div align="center">
  ...
  <h3>REPORTE SEMANAL RESULTADOS</h3>
...
<?php
$fecha =$_POST['Anual'].$_POST['Mes'].$_POST['Dia'];
$dia=$_POST['Dia'];
$dia2=$dia+07;
$fecha2 = $_POST['Anual'].$_POST['Mes'].$dia2;
...
<br>
<div>
<h3>Informe correspondiente a la semana: <?php echo ($_POST['Anual']."-".$_POST['Mes']."-".$_POST['Dia']);?></h3> 
</div>  
...
//Preparaci�n y ejecuci�n de la consulta
  $consulta = "SELECT ti.numeroticket, ve.modelo, ve.placa, ve.tipovehiculo, ti.horaentrada, ti.horasalida, ti.monto FROM ticket as ti INNER JOIN vehiculo as ve ON ti.numeroticket = ve.id WHERE ti.fechaentrada BETWEEN $fecha AND $fecha2;";
  //$consulta = "SELECT * FROM ticket WHERE FechaEntrada BETWEEN $fecha AND $fecha2;";
